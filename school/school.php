...
$sql = "INSERT INTO SCHOOL (school_id, school_name, school_address, school_email, school_phone)
...
<tr>
<td>Phone Number:</td><td><input type='text' name='Phone' style='width:200px' value= "" required></td>
</tr>
<tr>	
