...
if($result->num_rows > 0){
	while($row = $result->fetch_assoc()){
		...
		<td><a href="deleteProcess.php?delete=<?php echo $row['manager_id'];?>" 
		    class="btn btn-danger">Delete</a>
			<a href="edit.php?edit=<?php echo $row['manager_id'];?>" 
...
?>
	...
	<button type="button" id="addButton">Add new Manager</button>
